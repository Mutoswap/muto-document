...
**Specifics:**
* Lottery Ticket Fee for 1 ticket: 10  DTO
* Single User Lottery Entry Limit: No limit
* Paying for one ticket \(10 DTO\) will give users a random 4 digit combination with each digit being between 1-14, for e.g. “1-9-3-2”
* In the UI, users can choose to enter a multiple of 10 DTO, which will buy them multiple tickets.
...
* Users will receive a ticket \(comprised of 4 digits\) for each 10 DTO paid.
...
* The 2nd lottery number will be determined based on the %10 remainder of a hash encoded by the blockhash and the total pooled DTO balance at the entry deadline.
